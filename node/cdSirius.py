...
def main():
    ...
    response.add_column('Compounds', 'Top ClassFire Kingdom', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Kingdom', 'RelativePosition', '1091')
    response.add_column('Compounds', 'Top ClassFire Superclass', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Superclass', 'RelativePosition', '1092')
    response.add_column('Compounds', 'Top ClassFire Class', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Class', 'RelativePosition', '1093')
    response.add_column('Compounds', 'Top ClassFire Subclass', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Subclass', 'RelativePosition', '1094')
    response.add_column('Compounds', 'Top ClassFire Level 5', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Level 5', 'RelativePosition', '1095')
    response.add_column('Compounds', 'Top ClassFire Level 6', 'String')
    response.set_column_option('Compounds', 'Top ClassFire Level 6', 'RelativePosition', '1096')
    ...
    if doCSIFID:
        ...
        response.set_column_option('SiriusStructures', 'MS1 ΔMass [ppm]', 'RelativePosition', '41')
        response.set_column_option('SiriusStructures', 'MS1 ΔMass [ppm]', 'FormatString', 'F2')
